package com.khorbos.oreseverywhere.core.util.helpers;
...
public class KeyboardHelper {
    ...
    public static boolean isHoldingCtrl(){
        return InputMappings.isKeyDown(WINDOW, GLFW.GLFW_KEY_RIGHT_CONTROL) || InputMappings.isKeyDown(WINDOW, GLFW.GLFW_KEY_RIGHT_CONTROL);
    }
}
