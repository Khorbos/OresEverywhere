...
public class MiningWorldChunkGenerator extends NoiseChunkGenerator<MiningWorldGenSettings> {
    ...
    public MiningWorldChunkGenerator(IWorld worldIn, BiomeProvider provider, MiningWorldGenSettings settingsIn) {
