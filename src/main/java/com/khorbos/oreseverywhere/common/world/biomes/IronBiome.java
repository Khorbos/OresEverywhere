...
public class IronBiome extends Biome {
        ...
        this(new Builder()
                ...
                .surfaceBuilder(
                        new ConfiguredSurfaceBuilder<SurfaceBuilderConfig>(
                                register("iron_surface",
                                        new OreBiomeSurfaceBuilder(SurfaceBuilderConfig::deserialize, Registries.IRON_GRASS.get(), Blocks.IRON_ORE, Blocks.IRON_BLOCK)),
    ...
    public IronBiome(Builder biomeBuilder) {
        super(biomeBuilder);
        ...
        this.addSpawn(EntityClassification.CREATURE, new SpawnListEntry(EntityType.IRON_GOLEM, 12, 2, 3));
        ...
        this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
                Feature.NORMAL_TREE.withConfiguration(IronTree.IRON_TREE_CONFIG).withPlacement(
