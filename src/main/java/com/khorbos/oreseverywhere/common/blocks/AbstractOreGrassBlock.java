...
public abstract class AbstractOreGrassBlock extends SpreadableSnowyDirtBlock implements IGrowable {
    protected AbstractOreGrassBlock(Properties builder) {
        super(builder);
    }
    ...
    protected void initCanGrow(ServerWorld worldIn, Random rand, BlockPos pos, BlockState state, BlockPos blockpos, BlockState blockstate){
        for(int i = 0; i < 128; ++i) {
